...
class GrainShader extends BasicShader
{
	public function new(grainAmount:Float = 0.05, enableColors:Bool = false, colorAmount:Float = 0.6, grainSize:Float = 1.6, luminance:Float = 1.0)
	{
		super();
	...
	{
		setProperty("colored", 1.0);
	}
	
	public function disableColor()
	{
		setProperty("colored", 0);
	}
	
	public function setGrainAmount(amount:Float)
	{
		setProperty("grainamount", amount);
	}
	
	public function setColorAmount(amount:Float)
	{
		setProperty("coloramount", amount);
	}
	
	public function setGrainSize(amount:Float)
	{
		setProperty("grainsize", amount);
	}
	
	public function setLuminance(amount:Float)
	{
		setProperty("lumamount", amount);
	}
}