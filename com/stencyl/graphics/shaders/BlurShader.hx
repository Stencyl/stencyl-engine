...
class BlurShader extends BasicShader
{
	public function new(radius:Float = 2.0, dirX:Float = 1.0, dirY:Float = 1.0)
	{
		super();
	...
	public function setRadius(amount:Float)
	{
		setProperty("radius", amount);
	}
	
	public function setDirectionX(amount:Float)
	{
		setProperty("dirx", amount);
	}
	
	public function setDirectionY(amount:Float)
	{
		setProperty("diry", amount);
	}
}