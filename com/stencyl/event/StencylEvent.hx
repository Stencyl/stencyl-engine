...
class StencylEvent 
{
	...
	public static var FULL_AD_USER_OPEN:Int = 104;
	public static var FULL_AD_USER_CLOSE:Int = 105;
	public static var FULL_AD_LOADED:Int = 106;
	public static var FULL_AD_FAILED:Int = 107;
