...
public class BillingHelper {
	 ...
	 * @param notifyIds
	 */
	public static void getPurchaseInformation(String[] notifyIds){
		if (amIDead()) {
			return;
		}
	 ...
	 * 
	 * A CONFIRM_NOTIFICATIONS request triggers a single asynchronous response RESPONSE_CODE broadcast intent. 
	 ...
	 * @param notifyIds
	 */
	public static void confirmTransaction(String[] notifyIds) {
		if (amIDead()) {
			return;
		}
